#!/bin/bash
# fedora.sh - Fedora-specific cloud-init generation
...
runcmd:
  ...
  # (works across all Fedora versions)
  - curl -sfL https://raw.githubusercontent.com/aquasecurity/trivy/main/contrib/install.sh | \
      sh -s -- -b /usr/local/bin || \
      echo "Trivy installation failed, continuing..."
...
final_message: |
  Snail Core VM ${vm_name} (Fedora ${version}) is ready!
